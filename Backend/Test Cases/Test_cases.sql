...
/*discounts*/
insert into discount(description, tier, amount) values ('10% coupon', 1, 10.0);
insert into discount(description, tier, amount) values ('20% coupon', 2, 20.0);
insert into discount(description, tier, amount) values ('30% coupon', 3, 30.0);
insert into discount(description, tier, amount) values ('40% coupon', 4, 40.0);
insert into discount(description, tier, amount) values ('50% coupon', 5, 50.0);
